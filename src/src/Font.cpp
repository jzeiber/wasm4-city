...
void DrawCharOld(char c)
{
	...
	for (int row = 0; row < FONT_HEIGHT; row++)
	{
		...
		PutPixel(PrintX, y, (data & 8) ? PALETTE_BLACK : PALETTE_WHITE);
		PutPixel(PrintX + 1, y, (data & 4) ? PALETTE_BLACK : PALETTE_WHITE);
		PutPixel(PrintX + 2, y, (data & 2) ? PALETTE_BLACK: PALETTE_WHITE);
		PutPixel(PrintX + 3, y, PALETTE_WHITE);
		y++;
	}
}
